...
def main(argv):
    ...
    if not order_rows:
        raise SystemExit(f"add payload is missing track member orders for {dataset_name}")
    if not locator_rows:
