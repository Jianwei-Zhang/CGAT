...
export function buildAssemblyContextMenuActions(actionDeps, overrides = {}) {
  ...
  return {
    ...
    moveContextSubviewMemberToOtherLane: resolveAction("moveContextSubviewMemberToOtherLane"),
    removeContextSubviewMember: resolveAction("removeContextSubviewMember"),
    ...
    openDegapSettings: resolveAction("openDegapSettings"),
    requestDegapGapJob: resolveAction("requestDegapGapJob"),
    requestDegapTelseekerJob: resolveAction("requestDegapTelseekerJob"),
    ...
    copySubviewAnchorWithOffset: resolveAction("copySubviewAnchorWithOffset"),
    deleteSubviewManualAnchor: resolveAction("deleteSubviewManualAnchor"),
