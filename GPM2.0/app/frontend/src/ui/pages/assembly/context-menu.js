...
export function resolveSubviewAnchorEdgeContextTarget(target) {
  ...
  const parseEvidenceEdge = (edgeNode) => {
    ...
    return {
      ...
      topName: String(edgeNode.getAttribute("data-subview-anchor-top-name") || "").trim(),
      bottomName: String(edgeNode.getAttribute("data-subview-anchor-bottom-name") || "").trim(),
      topSourceLabel: String(edgeNode.getAttribute("data-subview-anchor-top-source-label") || "").trim(),
      bottomSourceLabel: String(edgeNode.getAttribute("data-subview-anchor-bottom-source-label") || "").trim(),
      topSourceRole: String(edgeNode.getAttribute("data-subview-anchor-top-source-role") || "").trim(),
      bottomSourceRole: String(edgeNode.getAttribute("data-subview-anchor-bottom-source-role") || "").trim(),
      topSourceKind: String(edgeNode.getAttribute("data-subview-anchor-top-source-kind") || "").trim(),
      bottomSourceKind: String(edgeNode.getAttribute("data-subview-anchor-bottom-source-kind") || "").trim(),
      topSourceName: String(edgeNode.getAttribute("data-subview-anchor-top-source-name") || "").trim(),
      bottomSourceName: String(edgeNode.getAttribute("data-subview-anchor-bottom-source-name") || "").trim(),
