import { ArrowRight, Check, Copy, Folder, FolderOpen, FolderInput, PackagePlus, Pencil, Trash2, X } from "lucide";

const icons = { arrow: ArrowRight, check: Check, copy: Copy, folder: Folder, open: FolderOpen, import: FolderInput, addPackage: PackagePlus, delete: Trash2, rename: Pencil, close: X };
